{
  "@context": [
    ...
    "https://linkedsoftwaredependencies.org/bundles/npm/@comunica/bus-rdf-parse/^5.0.0/components/context.jsonld"
  ],
  ...
  "components": [
    {
      ...
      "parameters": [
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#ActorRdfParseJsonLd_args_cacheSize",
          "range": "xsd:integer",
          "default": "128",
          "comment": "The maximum number of entries in the LRU cache, set to 0 to disable."
        },
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#ActorRdfParseJsonLd_args_httpInvalidator",
          "range": "cbhi:components/ActorHttpInvalidateListenable.jsonld#ActorHttpInvalidateListenable",
          "default": {
            "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#IActorRdfParseJsonLdArgs_default_invalidator",
        ...
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#ActorRdfParseJsonLd_args_busFailMessage",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              "xsd:string",
      ...
      "memberFields": [
        ...
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#ActorRdfParseJsonLd__member_httpInvalidator",
          "memberFieldName": "httpInvalidator",
          "range": "cbhi:components/ActorHttpInvalidateListenable.jsonld#ActorHttpInvalidateListenable"
        },
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#ActorRdfParseJsonLd__member_cache",
    ...
    },
    {
      ...
      "memberFields": [
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#IActorRdfParseJsonLdArgs__member_cacheSize",
          "memberFieldName": "cacheSize"
        },
        {
          "@id": "carpj:components/ActorRdfParseJsonLd.jsonld#IActorRdfParseJsonLdArgs__member_httpInvalidator",
          "memberFieldName": "httpInvalidator"
        },
        {
