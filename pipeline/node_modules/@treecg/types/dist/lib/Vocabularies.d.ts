...
export declare const TREE: {
    namespace: string;
    custom: (input: string) => string;
} & RecordOf<("search" | "path" | "node" | "value" | "Collection" | "Relation" | "Node" | "Member" | "member" | "view" | "relation" | "PrefixRelation" | "SubstringRelation" | "SuffixRelation" | "GreaterThanRelation" | "GreaterThanOrEqualToRelation" | "LessThanRelation" | "LessThanOrEqualToRelation" | "EqualToRelation" | "GeospatiallyContainsRelation" | "shape" | "ConditionalImport" | "import" | "importStream" | "remainingItems" | "zoom" | "latitudeTile" | "longitudeTile")[], string> & {
