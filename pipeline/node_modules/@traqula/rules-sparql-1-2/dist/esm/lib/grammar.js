...
function reifiedTripleBlockImpl(name, allowPath) {
    return {
        ...
        impl: ({ ACTION, SUBRULE }) => (C) => {
            ...
            const properties = SUBRULE(allowPath ? S11.propertyListPath : S11.propertyList, ACTION(() => C.astFactory.dematerialized(triple.identifier)));
...
export const unaryExpression = {
    ...
    impl: ({ ACTION, CONSUME, SUBRULE1, SUBRULE2, OR1, OR2 }) => C => OR1([
        ...
        { ALT: () => {
                ...
                return ACTION(() => C.astFactory.expressionOperation(operator.image === '+' ? 'UPLUS' : 'UMINUS', [expr], C.astFactory.sourceLocation(operator, expr)));
            } },
    ]),
};
/**
