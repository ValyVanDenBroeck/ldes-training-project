...
exports.TREE = createUriAndTermNamespace('https://w3id.org/tree#', 'Collection', 'Relation', 'Node', 'Member', 'member', 'view', 'value', 'relation', 'PrefixRelation', 'SubstringRelation', 'SuffixRelation', 'GreaterThanRelation', 'GreaterThanOrEqualToRelation', 'LessThanRelation', 'LessThanOrEqualToRelation', 'EqualToRelation', 'GeospatiallyContainsRelation', 'path', 'node', 'shape', 'search', 'ConditionalImport', 'import', 'importStream', 'remainingItems', 'zoom', 'latitudeTile', 'longitudeTile');
