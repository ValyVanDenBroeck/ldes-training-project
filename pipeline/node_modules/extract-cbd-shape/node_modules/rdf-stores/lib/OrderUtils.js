...
exports.getBestIndexTerms = getBestIndexTerms;
exports.getIndexMatchTermsPath = getIndexMatchTermsPath;
 ...
 */
function getBestIndexTerms(componentOrders, terms) {
 ...
 */
function getIndexMatchTermsPath(componentOrder, terms) {
    const matchTerms = [];
    let termsI = 0;
